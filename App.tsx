  ...
  characters: [
    {
      ...
      image: "/assets/characters/Monkey D. Luffy.png",
      chibiImage: "/assets/characters/Monkey D. Luffy_Chibi.png",
      correctSeat: "D",
    ...
    },
    {
      id: "scholar",
      name: "CENDEKIAWAN",
      role: "Cendekiawan Perpustakaan",
      shortBio: "Menyukai posisi tengah depan untuk mencatat seluk-beluk semua awak.",
      statement: "Dudukkan saya di Kursi B tepat di sebelah Pemusik. Saya perlu mengamati bintang-bintang laut dari sudut kiri depan.",
      profileText: "Pengamat setia sejarah pelayaran. Suka mencatat seluk-beluk dan alibi anggota awak lain.",
      image: "/assets/characters/scholar.png",
      chibiImage: "/assets/characters/scholar_chibi.png",
      correctSeat: "B",
    ...
    },
    {
      id: "archaeologist",
      name: "PENELITI",
      role: "Peneliti Purbakala",
      shortBio: "Mempelajari prasasti kuno dan peta tua. Membutuhkan ketenangan.",
      statement: "Saya milik Kursi C. Kursi itu sejajar langsung dengan rasi bintang utara saat saya mengamatinya melalui teropong.",
      profileText: "Peneliti artefak kuno yang selalu membawa kacamata pembesar dan dokumen kuno.",
      image: "/assets/characters/archaeologist.png",
      chibiImage: "/assets/characters/archaeologist_chibi.png",
      correctSeat: "C",
    ...
    },
    {
      id: "marine",
      name: "PERWIRA",
      role: "Perwira Angkatan Laut",
      shortBio: "Penjaga berdisiplin tinggi yang menjaga ketertiban di geladak.",
      statement: "Saya akan mengamankan Kursi E di tengah geladak. Dari E, saya bisa mengawasi haluan maupun buritan secara efektif.",
      profileText: "Mantan prajurit berkedisiplinan tinggi. Memastikan tidak ada perselisihan antar awak kapal.",
      image: "/assets/characters/marine.png",
      chibiImage: "/assets/characters/marine_chibi.png",
      correctSeat: "E",
      avatarBg: "from-indigo-900/60 to-slate-900",
    ...
    },
    {
      ...
      name: "KOKI KAPAL",
      role: "Koki Kapal",
      shortBio: "Menyiapkan makanan dan memeriksa stok bahan segar.",
      statement: "Berikan saya Kursi F. Tepat di sebelah palka dapur tempat saya mengeluarkan hidangan hangat untuk semua orang.",
      profileText: "Pria ramah beraroma rempah-rempah yang selalu mengawasi pembagian jatah makanan harian.",
      image: "/assets/characters/cook.png",
      chibiImage: "/assets/characters/cook_chibi.png",
      correctSeat: "F",
    ...
    },
    {
      ...
      name: "NAVIGATOR",
      role: "Ahli Navigasi",
      shortBio: "Pembaca peta pelayaran dan pemegang kompas.",
      statement: "Kursi G adalah milik saya. Memiliki pemandangan paling jelas ke kemudi utama dan penunjuk arah angin.",
      profileText: "Bertanggung jawab menentukan arah gelombang dan posisi lintang kapal di tengah lautan.",
      image: "/assets/characters/navigator.png",
      chibiImage: "/assets/characters/navigator_chibi.png",
      correctSeat: "G",
    ...
    },
    {
      ...
      name: "DOKTER KAPAL",
      role: "Dokter Kapal",
      shortBio: "Membawa kotak obat-obatan dan ramuan herbal.",
      statement: "Saya membutuhkan Kursi H agar tetap dekat dengan pintu ruang pengobatan jika ada yang mabuk laut saat ombak tengah malam.",
      profileText: "Tenang dan selalu teliti memeriksa kesehatan awak kapal setelah badai menerjang.",
      image: "/assets/characters/doctor.png",
      chibiImage: "/assets/characters/doctor_chibi.png",
      correctSeat: "H",
      avatarBg: "from-emerald-900/60 to-slate-900",
      accentColor: "border-emerald-500/50"
    },
    {
      id: "astronomer",
      name: "PENGAMAT BINTANG",
      role: "Pengamat Bintang",
      shortBio: "Mencatat rasi bintang malam hari.",
      statement: "Kursi I memberi saya ketinggian tanpa halangan untuk mengukur sudut benda langit tanpa terhalang bayangan tiang kapal.",
      profileText: "Selalu sibuk mencatat pergerakan bulan dan arah tiupan angin malam.",
      image: "/assets/characters/astronomer.png",
      chibiImage: "/assets/characters/astronomer_chibi.png",
      correctSeat: "I",
    ...
    },
    {
      ...
      name: "KAPTEN",
      role: "Kapten Kapal",
      shortBio: "Komandan utama Geladak Robin.",
      statement: "Saya akan mengambil Kursi J di tahta buritan. Seorang kapten sejati memimpin dari belakang untuk mengawasi seluruh awaknya.",
      profileText: "Pemimpin legendaris geladak kapal. Teguh dan sangat dihormati oleh seluruh awak.",
      image: "/assets/characters/captain.png",
      chibiImage: "/assets/characters/captain_chibi.png",
      correctSeat: "J",
      avatarBg: "from-red-900/60 to-slate-900",
